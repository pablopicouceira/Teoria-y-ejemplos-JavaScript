...
/**
 * Si tratamos de recuperar el `return` que nos devuelve
 * la función asíncrona almacenando el valor de la
 * función en una constante de la forma habitual no
 * funcionará. Recordad que la función asíncrona
 * esperará a tener toda la información antes de
 * devolver algo.
 *
 * El siguiente código es síncrono, por tanto se
 * ejecutará antes de que a la función asíncrona le de
 * tiempo a descargar toda la información.
 */
...
/**
 * Podemos recuperar el `return` empleando el `.then`
 * que hemos visto en el apartado de promesas. Esto es
 * debido a que la función asíncrona devuelve una nueva
 * promesa.
 */
